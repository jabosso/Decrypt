...
#ifndef ESPERIMENTI_DES_H
#define ESPERIMENTI_DES_H
#include<bits/stdc++.h>
#include "text_conv.h"
...
string encrypt(string pt, vector<string> rkb, vector<string> rk){
   ...
   // cout<<endl;
    ...
    string tmp1 = tmp.substr(0,32);
    string tmp2 = tmp.substr(32,32);
    string cipher1= bin2hex(tmp1);
    string cipher2= bin2hex(tmp2);
    string cipher = cipher1+cipher2;
    //string cipher;
    return cipher;
}
#endif //ESPERIMENTI_DES_H
